...
![Version: 1.31.0](https://img.shields.io/badge/Version-1.31.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| istio.git.tag | string | `"1.13.2-bb.0"` |  |
...
| jaeger.git.tag | string | `"2.29.0-bb.0"` |  |
...
| kiali.git.tag | string | `"1.47.0-bb.4"` |  |
...
| clusterAuditor.git.tag | string | `"1.4.0-bb.1"` |  |
...
| gatekeeper.git.tag | string | `"3.7.1-bb.0"` |  |
...
| kyverno.git.tag | string | `"2.2.0-bb.3"` |  |
...
| kyvernopolicies.git.tag | string | `"1.0.0-bb.8"` |  |
...
| logging.git.tag | string | `"0.7.0-bb.1"` |  |
...
| eckoperator.git.tag | string | `"2.0.0-bb.1"` |  |
...
| fluentbit.git.tag | string | `"0.19.20-bb.2"` |  |
...
| promtail | object | `{"enabled":false,"flux":{},"git":{"path":"./chart","repo":"https://repo1.dso.mil/platform-one/big-bang/apps/sandbox/promtail.git","tag":"3.11.0-bb.0"},"postRenderers":[],"values":{}}` | BETA support of promtail/loki logging stack |
...
| loki.git.tag | string | `"2.10.1-bb.4"` |  |
...
| tempo.git.tag | string | `"0.14.2-bb.1"` |  |
...
| monitoring.git.tag | string | `"33.2.0-bb.3"` |  |
...
| twistlock.git.tag | string | `"0.5.0-bb.0"` |  |
...
| addons.argocd.git.tag | string | `"4.2.3-bb.1"` |  |
...
| addons.authservice.git.tag | string | `"0.4.0-bb.26"` |  |
...
| addons.minioOperator.git.tag | string | `"4.4.12-bb.3"` |  |
...
| addons.minio.git.tag | string | `"4.4.12-bb.1"` |  |
...
| addons.gitlab.git.tag | string | `"5.9.2-bb.1"` |  |
...
| addons.gitlabRunner.git.tag | string | `"0.38.1-bb.1"` |  |
...
| addons.nexus.git.tag | string | `"37.3.0-bb.2"` |  |
...
| addons.sonarqube.git.tag | string | `"9.6.3-bb.23"` |  |
...
| addons.anchore.git.tag | string | `"1.17.1-bb.2"` |  |
...
| addons.mattermost.git.tag | string | `"0.7.0-bb.1"` |  |
...
| addons.velero.git.tag | string | `"2.29.0-bb.1"` |  |
...
| addons.keycloak.git.tag | string | `"17.0.1-bb.2"` |  |
...
| addons.vault.git.tag | string | `"0.19.0-bb.6"` |  |
| addons.vault.flux | object | `{}` | Flux reconciliation overrides specifically for the Vault Package |
| addons.vault.ingress | object | `{"gateway":""}` | Redirect the package ingress to a specific Istio Gateway (listed in `istio.gateways`).  The default is "public". |
